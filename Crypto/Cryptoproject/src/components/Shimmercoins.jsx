...
export default function Shimmercoins(){
    ...
    return(
        ...
        <>
        <div className="bg-gray-800  mx-[0] my-2 px-5 py-4 gap-3px rounded-lg shadow-md border border-gray-700 flex justify-between items-center animate-pulse">
      <div>
  ...
  <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-indigo-600 opacity-25"></span>
